...
// remain     = TotalHoursWithoutSkippedEnglish - EnglishHoursPassed;
    ...
    $(".ts4").after("<a target='_blank' style='font-family:tahoma,serif;target=_blank;float:right;margin-right:13px;font-size:9px;margin-top:3px;color:#808080' href='http://svu-ise.com/avg'>last update: " + last_update + "</a>");
})();
